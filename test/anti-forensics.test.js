...
const ATTACKS = [
  ...
  ['edit the Gemini hooks settings', { action_type: 'file_edit', target: '/Users/x/.gemini/settings.json' }],
  ['edit the Codex hooks file', { action_type: 'file_edit', target: '/Users/x/.codex/hooks.json' }],
  ['edit the Codex inline hooks config', { action_type: 'file_edit', target: '/Users/x/.codex/config.toml' }],
